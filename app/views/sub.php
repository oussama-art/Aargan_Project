...
$siteKey     = '6LdapyUpAAAAAMzT9fuB54pfmnEoLvNdTSoaZZyD'; 
$secretKey     = '6LdapyUpAAAAAEEvusskOHR3lo9ll4JdAZb7izY0'; 
 
// Email configuration 
$toEmail = 'oussamaraji39@gmail.com'; 
$fromName = 'Oriental Group'; 
$formEmail = 'oussamaraji39@gmail.com'; 
...
if(isset($_POST['Submit'])){ 
    ...
    if(empty($valErr)){      
        ...
        !empty($name) && !empty($email) && !empty($subject) && !empty($message)
         && !empty($phone) && preg_match("/^[a-zA-Z-' ]*$/",$name) 
         && preg_match('/^[0-9]{10}$/', $_POST['phone']) 
         && preg_match('/^[A-Za-z][A-Za-z0-9+?!\/\\\\ ]*$/', $message) 
         ){ 
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'oussamaraji39@gmail.com';
            $mail->Password = 'vozuydhwsgyivlno';
            $mail->Port =  587;
            $mail->SMTPSecure = 'tls';
            $mail->isHTML(true);
            $mail->setFrom($email, $name);
            $mail->addAddress('oussamaraji39@gmail.com');
